...
//             </li>
//             <li>
//               <MdLocationOn className='f_icon' /><span className='i-text'> NIT Silchar</span>
//             </li>
//             <li>
...
//           <a href="/" className="footer_social_Logo"><FacebookIcon/><span className="i-text">Facebook</span></a>
//           <a href="/" className="footer_social_Logo" id='link_ln'><LinkedInIcon /><span className="i-text">Linkedln</span></a>
//           <a href="/" className="footer_social_Logo" ><InstagramIcon className='foot_insta' /><span className="i-text">Instagram</span></a>
//         </div>
